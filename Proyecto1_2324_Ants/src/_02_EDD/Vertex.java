...
/**
 * Clase Vertex Esta clase define el objeto Vertice y su comportamiento, con sus
 * atributos numVertex y listAdy, que corresponden al identificador del vertice
 * y a la lista de arcos.
 *
 * @author AresR
 * @version 20/02/2024
 */
public class Vertex implements IVertex {
    ...
    /**
     * Convierte el vértice a un formato de cadena de texto para ser guardado en
     * un archivo de texto.
     *
    ...
    /**
     * Verifica si un arco está presente en la lista de arcos adyacentes del
     * vértice.
     *
    ...
    /**
     * Busca un arco en la lista de arcos del vertice, con el numero del destino
     * deseado.
     *
     * @param numOfDestinationVertex numero que representa el destino del arco
     * deseado.
     * @return el arco encontrado con el numero indicado.
     */
