...
public interface IVertex {
    ...
    /**
     * Metodo a desarrollar para agregar un arco a la lista de arcos adyacentes del vértice.
    ...
    /**
     * Metodo a desarrollar para eliminar un arco de la lista de arcos adyacentes del vértice.
    ...
    /**
     * Metodo a desarrollar para modificar el número del vértice, reemplazandolo por 
     * el nuevo numero que lo identificará
     * @param numVertex El nuevo número del vértice.
     */
    public void SetNumVertex(int numVertex);
   
    /**
     * Metodo a desarrollar para obtener la lista de arcos adyacentes del vértice.
     * @return La lista de arcos adyacentes.
     */
    public LinkedSimpleList GetListAdy();
    
    /**
     * Metodo a desarrollar para modificar el atributo que representa la lista enlazada 
     * de arcos del vértice, reemplazandola por la nueva lista que se le indica.
