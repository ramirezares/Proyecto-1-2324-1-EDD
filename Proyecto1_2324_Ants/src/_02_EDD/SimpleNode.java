...
/**
 * Clase SimpleNode Esta clase define el objeto nodo y su comportamiento, con
 * sus atributos Data y Nxt
 *
 * @author AresR
 * @version 17/02/2024 (v2)
 * @param <A> Representa el tipo de dato que guardara el nodo. Se usa "<>" para
 * declararlo generico.
 */
