...
public interface ILinkedList<A> {
    ...
    /**
     * Metodo a desarrollar para verificar si una instancia de la clase
     * LinkedSimpleList se encuentra vacia
     *
     * @return Devuelve true si la instancia de la clase LinkedSimpleList no
     * contiene ni un nodo, es decir, los atributos pFirst y pLast apuntan a
     * null. En caso contrario devuelve false.
     */
    ...
    /**
     * Metodo a desarrollar para verificar si un valor determinado se encuentra
     * dentro dentro de una instancia de la clase LinkedSimpleList.
     *
     * @param Data Representa el valor que se busca dentro del la lista enlazada
     * @return Retorna true si el valor que se busca se encuentra dentro de la
     * lista. De lo contrario retorna false.
     */
    public boolean isDataInList(A Data);

    /**
     * Metodo a desarrollar para buscar el nodo que contiene un valor
     * determinado dentro de una instancia de la clase LinkedSimpleList.
     *
     * @param Data Representa el valor que se busca dentro del la lista enlazada
    ...
    /**
     * Metodo a desarrollar para eliminar el nodo que contiene un valor
     * determinado dentro de una instancia de la clase LinkedSimpleList.
     *
     * @param Data Representa el valor que se desea eliminar dentro del la lista
     * enlazada
     */
    ...
    /**
     * Metodo a desarrollar para obtener el nodo que se encuentra en un indice
     * especifico
     *
    ...
    /**
     * Metodo a desarrollar para obtener el nodo que se encuentra en la cabeza
     * de una instancia de la clase LinkedSimpleList.
     *
    ...
    /**
     * Metodo a desarrollar para obtener el nodo que se encuentra en la cola de
     * una instancia de la clase LinkedSimpleList.
     *
    ...
    /**
     * Metodo a desarrollar para modificar el atributo pLast de una instancia de
     * la clase LinkedSimpleList.
     *
    ...
    /**
     * Metodo a desarrollar para modificar el atributo Size de una instancia de
     * la clase LinkedSimpleList.
     *
